...
let input = prompt("Введите ваше имя и длину доски:");
const [name, size] = input.trim().split(" ");
const player1 = new Player(name, size);
console.log(`${player1.getName()}, ${player1.getBoardSize()}`);
