...
class App {
  ...
  run() {
    ...
    while (!win) {
      ...
      let input = prompt(`Ход игрока ${player.getName()}:`);
...
let input = prompt("Введите имя игрока: ", "Dimon");
let human = new HumanPlayer(input.trim(), 5);
// let x = 0;
// let y = 0;
// human.placeShips("ad", 1, 1, { x, y });
// console.log(human.getBoard().display());
